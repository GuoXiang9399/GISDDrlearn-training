...
#DENV-1
  ...
  save(test.Model_rawdata,
       file = "Result/rffit_test_rawdata_D1_Subgenotype.rda")
  #############################################################################
  #data preprocess
  Model_rawdata$Accession <- row.names(Model_rawdata)
  ...
  test.Model_rawdata<-Model_rawdata[-tindex,]
  save(test.Model_rawdata,
       file = "Result/rffit_test_rawdata_D1_Clade.rda")
###############################################################################
#DENV-2
  ...
  test.Model_rawdata<-Model_rawdata[-tindex,]
  save(test.Model_rawdata,
       file = "Result/rffit_test_rawdata_D2_Subgenotype.rda")
  #############################################################################
  #data preprocess
  Model_rawdata$Accession <- row.names(Model_rawdata)
  Model_rawdata <- left_join(Model_rawdata,GISDD_Clade)
  ...
  test.Model_rawdata<-Model_rawdata[-tindex,]
  save(test.Model_rawdata,
       file = "Result/rffit_test_rawdata_D2_Clade.rda")
###############################################################################
#DENV-3
  ...
  test.Model_rawdata<-Model_rawdata[-tindex,]
  save(test.Model_rawdata,
       file = "Result/rffit_test_rawdata_D3_Subgenotype.rda")
  #############################################################################
  #data preprocess
  Model_rawdata$Accession <- row.names(Model_rawdata)
  Model_rawdata <- left_join(Model_rawdata,GISDD_Clade)
  ...
  test.Model_rawdata<-Model_rawdata[-tindex,]
  save(test.Model_rawdata,
       file = "Result/rffit_test_rawdata_D3_Clade.rda")
###############################################################################
#DENV-4
  ...
  test.Model_rawdata<-Model_rawdata[-tindex,]
  save(test.Model_rawdata,
       file = "Result/rffit_test_rawdata_D4_Subgenotype.rda")
  #############################################################################
  #data preprocess
  Model_rawdata$Accession <- row.names(Model_rawdata)
  Model_rawdata <- left_join(Model_rawdata,GISDD_Clade)
  ...
  test.Model_rawdata<-Model_rawdata[-tindex,]
  save(test.Model_rawdata,
       file = "Result/rffit_test_rawdata_D4_Clade.rda")
